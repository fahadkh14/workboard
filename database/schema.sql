-- WorkBoard — MySQL schema
--
-- This file is a reference copy of the schema the backend creates
-- automatically on startup (see backend/src/config/db.js).
-- You do NOT need to run this by hand for the app to work —
-- `docker compose up` is enough, tables are created for you.
--
-- Use this file if you want to:
--   * inspect the schema without reading the backend code
--   * import it manually into an external / managed MySQL instance
--   * seed a fresh database ahead of time
--
-- Safe to re-run: every statement uses IF NOT EXISTS.

CREATE DATABASE IF NOT EXISTS workboard
